...
function actualizarUsuario($conexion, $id, $nombre, $correo, $rol, $pass) {
    ...
    $query_update = "UPDATE usuarios SET nombreUsuario='$nombre', correo='$correo', rol='$rol'" . 
...
function agregarUsuario($conexion, $nombre, $correo, $pass, $rol) {
    ...
    $insert_query = "INSERT INTO usuarios (nombreUsuario, correo, pass, rol, estado) VALUES ('$nombre', '$correo', '$pass_cifrada', '$rol', '$estado')";
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <a href="#" class="btn btn-success" data-toggle="modal" data-target="#editarUsuarioModal" data-id="<?php echo $data['id']; ?>" data-nombre="<?php echo $data['nombreUsuario']; ?>" data-correo="<?php echo $data['correo']; ?>" data-rol="<?php echo $data['rol']; ?>" data-pass="<?php echo $data['pass']; ?>" style="width: 100px; display: inline-flex; align-items: center; justify-content: center;">
