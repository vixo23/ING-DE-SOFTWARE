        ...
        if ($result > 0) {
            while ($data = mysql_fetch_assoc($query)) {
                ...
                <tr>
                    ...
                    <td><?php echo '$' . number_format($montoVisualizado, 0, ',', '.'); ?></td> <!-- Muestra el monto formateado a CLP -->
            ...
            echo "<tr><td colspan='8'>No hay ingresos registrados.</td></tr>";
        }
        ?>
        </tbody>
        <tfoot>
            <tr>
                ...
                <th><?php echo '$' . number_format($totalMonto, 0, ',', '.'); ?></th> <!-- Muestra el total formateado a CLP -->
                <th colspan="2"></th>
            </tr>
        </tfoot>
    </table>
