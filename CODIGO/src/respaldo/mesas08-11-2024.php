...
?>
    <div class="card">
        <div class="card-header text-center">
			<h4 class="my-3 text-center"><span class="badge badge-secondary">Sal&oacute;n <?php echo $nombre_salon; ?></span></h4>
                                    ...
                                    <div class="card-footer">
                                        <div class="description-block">
                                            <?php if (empty($resultPedido)) {
                                                echo '<a class="btn btn-outline-info" href="pedido.php?id_sala=' . $id . '&mesas=' . $mesas .'&mesa=' . $item . '">Atender</a>';
                                            } else {
												echo '<a class="btn btn-outline-info" href="pedido.php?id_sala=' . $id . '&mesas=' . $mesas .'&mesa=' . $item . '">Atender</a>';
