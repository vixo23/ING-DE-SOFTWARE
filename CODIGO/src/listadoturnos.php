...
<div class="table-responsive">
    <table class="table table-hover table-striped table-bordered mt-2" id="tbl">
        ...
        <tbody>
            <?php
            $query = mysqli_query($conexion, "SELECT * FROM turnos WHERE id_empresa='$id_empresa' ORDER BY nombreTurno");
            ...
            if ($result > 0) {
                while ($data = mysqli_fetch_assoc($query)) {
                    ...
                    ?>
                    <tr>
                        <td><?php echo $data['id_turnos']; ?></td>
                        <td><?php echo $data['nombreTurno']; ?></td>
                        <td><?php echo $estado; ?></td>
                        <td>
                            <a href="#" onclick="editartipocontrato(<?php echo $data['id_turnos']; ?>, '<?php echo $data['nombreTurno']; ?>',  <?php echo $data['status']; ?>)" class="btn btn-success">
                                <i class='fas fa-edit'></i>
                            </a>
                            <a href="#" onclick="abrirModalConfirmacion(<?php echo $data['id_turnos']; ?>)" class="btn btn-warning">
