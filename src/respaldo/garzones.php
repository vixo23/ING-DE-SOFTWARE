...
<div class="card">
    <div class="card-body">
        <form action="guardar_garzon.php" method="post" autocomplete="off" id="formulario">
            ...
            <!-- Nota Informativa -->
            <div class="row">
                <label for="nombre" style="color: gray; font-size: 0.9em;">Nota: No se puede repetir ni contraseña ni color</label>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" placeholder="Ingrese Contraseña (máximo 6 caracteres)" name="pass" id="pass" maxlength="6" required oninput="if(this.value.length > 6) this.value = this.value.slice(0, 6);">
