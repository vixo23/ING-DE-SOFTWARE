                                ...
                                if ($result > 0) {
                                    while ($data = mysqli_fetch_assoc($query)) { ?>
                                        <div class="col-md-3">
                                            ...
                                            <h6 class="my-1"><?php echo $data['nombre']; ?></h6>
                                            <div class="bg-gray py-1 px-2 mt-1">
                                                <h6 class="mb-0">$ <?php echo number_format($data['precio'], 0, '.', ','); ?></h6>
                                            </div>
                                            <div class="mt-1">
                                                <a class="btn btn-primary btn-block btn-sm addDetalle" href="#" data-id="<?php echo $data['id']; ?>">
