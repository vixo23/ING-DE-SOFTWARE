...
if (isset($_SESSION['nombre'])) {
    // echo "Sesión activa para el usuario: " . $_SESSION['nombre'];
} else {
    // echo "No hay sesión activa o usuario en la sesión.";
}
...
// Crear la conexión
$conexion = mysqli_connect('localhost', 'root', 'admin1025', 'resto');

if (!$conexion) {
    die("Error de conexión: " . mysqli_connect_error());
}
mysqli_set_charset($conexion, 'utf8'); // Establecer la codificación a UTF-8
...
$idUser = $_SESSION['idUser']; // Asegúrate de que el ID de usuario se haya guardado en la sesión
...
$result_verificar_caja = mysqli_query($conexion, $query_verificar_caja_activa);

if (mysqli_num_rows($result_verificar_caja) > 0) {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $id_caja = mysqli_real_escape_string($conexion, $_POST['id_caja']);
        $id_turno = mysqli_real_escape_string($conexion, $_POST['id_turno']);
        $monto_apertura = mysqli_real_escape_string($conexion, $_POST['monto_apertura']);
    ...
    <div class="col-md-6">
        ...
        <form action="" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="id_usuario" name="id_usuario" value="<?php echo $_SESSION['nombreUsuario']; ?>" readonly>
            </div>
            ...
            <div class="form-group d-flex justify-content-between">
                <div class="w-50 pr-2">
                    ...
                    <select class="form-control" id="id_caja" name="id_caja" required>
                        ...
                        $result_cajas = mysqli_query($conexion, $query_cajas);
                        if ($result_cajas) {
                            while ($row = mysqli_fetch_assoc($result_cajas)) {
