...
?>
    <div class="card card-primary card-outline">
        ...
        <div class="card-header text-center">
            ...
            <span class="my-3 text-center"><span class="badge badge-secondary">Sal&oacute;n <?php echo $nombre_salon; ?></span></span>
        ...
        <div class="row">
			...
			if ($result > 0) {
				while ($data = mysqli_fetch_assoc($query)) { 
					...
					$mesaColor = empty($result) ? 'bg-success' : '';
                    $colorStyle = empty($result) ? '' : 'background-color: ' . $data['color'] . ';';
					$urlss="location.href=". $urls ."&grupo=".$data['id'];
            ?>
                    <div class="col-md-3">
                        <div class="card card-widget widget-user">
                            <div class="widget-user-header <?php echo $mesaColor; ?>" style="<?php echo $colorStyle; ?>">
                                <h3 class="widget-user-desc"><?php echo  $data['nombre']; ?></h5>

                               <input type="button" style="<?php echo $colorStyle ; ?>" 
						onclick="location.href='<? echo $urls."&grupo=".$data['id']; ?>';" value="Acceder" />
